...
class Ui_MainWindow(object):
    ...
    def open_img(self):
        ...
        if not os.path.exists(dir):
            ...
            os.makedirs(dir)
        try:
            # self.img_name - choosing image path
    ...
    def open_vid(self):
        ...
        try:
            # self.img_name - choosing image path
            self.vid_name, _ = QtWidgets.QFileDialog.getOpenFileName(None, "Open Video", "data/videos", "*.mp4;*.mkv;All Files(*)")
        except OSError as reason:
            print(str(reason))
        else:
            if not self.vid_name:
                ...
                #self.ui.message_box.append("Failed")
                pass
            else:
    ...
    def load_model(self):
        try:
            ...
            if self.openfile_name_model:
                ...
                #QtWidgets.QMessageBox.warning(self, u"Warning", u"No weight file, please select a weight file first.", buttons=QtWidgets.QMessageBox.Ok, defaultButton=QtWidgets.QMessageBox.Ok)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.image_label_3.setText(_translate("MainWindow", "YOLO GKD: Real-Time Weapon Detection for Surveillance using Enhanced YOLOv5"))
