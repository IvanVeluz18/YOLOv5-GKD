...
Where the Program Fits in the General System Design:
                This is the Algorithm that processes the detection. This is mainly the back-end of the system.
...
Data Structures, Algorithms, and Control:
    Algorithms: YOLO Algorithm, Convolutional Neural Network
    Control: If Else Statement, Try Catch Statement, Iterations
    Data Structures: Lists, Tuple, Set
